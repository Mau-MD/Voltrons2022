...
@Config
@TeleOp(name="Red Wobble", group="auto")
public class RedWobble extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            drive.backTimed(0.3, 1500, 180, gyroKp);
            ...
            drive.backTimed(0.3, 970, 90, gyroKp);

            drive.setOrientation(0.4, 180, 3000);

            drive.frontTimed(0.6, 2400, 180, gyroKp * 2);
